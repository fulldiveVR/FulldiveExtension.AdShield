...
//        }
        ...
        tabs.getTabAt(0)?.setTabText(getString(R.string.userdenied_tab_blocked))
        tabs.getTabAt(1)?.setTabText(getString(R.string.userdenied_tab_allowed))
        ...
        tabs.addOnTabSelectedListener(object : TabLayout.OnTabSelectedListener {
            ...
            override fun onTabSelected(tab: Tab) {
                tabs.setSelectedTabIndicator(indicators[tab.position % indicators.size])
                tab.updateSize()
                tab.updateFont()
